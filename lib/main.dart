...
import 'package:rifultravel/travelcard.dart';
...
class _TravelAppState extends State<TravelApp> {
  ...
  List<String> urls = [
    ...
    "https://i.pinimg.com/originals/f1/43/d0/f143d00433afcaa1a76d4ac911769b6b.jpg"
  ];
                          ...
                          Container(
                            child: ListView(
                              ...
                              children: [
                                ...
                                travelCard(
                                    urls[0], "Luxary Hotel", "Khulna", 3),
                                travelCard(urls[5], "Plaza Hotel", "Dhaka", 4),
                                travelCard(
                                    urls[2], "Sundarbon Hotel", "Bangladesh", 5),
                              ],
                            ),
                          ),
                          Container(
                            child: ListView(
                              ...
                              children: [
                                ...
                                travelCard(urls[8], "Saint Martin Island",
                                    "Bangladesh", 4),
